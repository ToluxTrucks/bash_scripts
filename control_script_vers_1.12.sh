#!/bin/bash
#Purpose:Turning Scripts into Functions
#Website: Toluxtrucks.com
#Created Date: Sun Nov 6 13:24:36 EST 2022
...
1) echo "You selected the file or directory copy function"
   backup_f_d dummy.py aws/jul2022 tolu f
   ;;
2) echo "You selected the delete function"
   delete_f_d dummy.py aws/jul2022 tolu f
   ;;
